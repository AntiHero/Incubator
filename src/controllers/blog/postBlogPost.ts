...
export const postBlogPost = [
  ...
  body(PostFields.title)
    ...
    .withMessage(ErrorMessages.MAX_LENGTH_ERROR(MAX_TITLE_LEN))
    .trim()
    .not()
    .isEmpty()
  ...
  body(PostFields.content)
    ...
    .withMessage(ErrorMessages.MAX_LENGTH_ERROR(MAX_CONTENT_LEN))
    .trim()
    .not()
    .isEmpty()
    .withMessage(ErrorMessages.EMPTY_STRING_ERROR),
  body(PostFields.shortDescription)
    ...
    .withMessage(ErrorMessages.MAX_LENGTH_ERROR(MAX_SHORT_DESCR_LEN))
    .trim()
    .not()
    .isEmpty()
    .withMessage(ErrorMessages.EMPTY_STRING_ERROR),
